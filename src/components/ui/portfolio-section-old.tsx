				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					{projects.map((project, idx) => (
						...
						>
							{/* Project image */}
							{project.image ? (
								<div className="aspect-video bg-gradient-to-br from-orange-500 to-amber-500 overflow-hidden">
									<img 
										src={project.image} 
