...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "portfolio.filter.bot": "Bots",
    "portfolio.filter.web": "Web",
    "portfolio.project1.title": "AI Environment",
    "portfolio.project1.desc": "Business-dating startup: MVP development and initial concept design",
    "portfolio.project1.tech": "React, AI/ML, Product Design",
    "portfolio.project2.title": "SOVereign VPN",
    ...
    "portfolio.project3.title": "MemStar",
    "portfolio.project3.desc": "Automated Telegram Stars purchase system with RUB payment integration",
    "portfolio.project3.tech": "Node.js, Telegram API, Payment APIs",
  ...
  ru: {
    ...
    "portfolio.filter.ai": "AI",
    "portfolio.filter.bot": "Боты",
    "portfolio.filter.web": "Веб",
    "portfolio.project1.title": "Окружение AI",
    "portfolio.project1.desc": "Бизнес-дейтинг стартап: разработка MVP и первичной концепции",
    "portfolio.project1.tech": "React, AI/ML, Product Design",
    "portfolio.project2.title": "SOVereign VPN",
    ...
    "portfolio.project3.title": "MemStar",
    "portfolio.project3.desc": "Автоматизированная система покупки Telegram Stars с интеграцией оплаты в рублях",
    "portfolio.project3.tech": "Node.js, Telegram API, платёжные API",
